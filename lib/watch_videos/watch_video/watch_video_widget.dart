...
import 'watch_video_model.dart';
export 'watch_video_model.dart';

class WatchVideoWidget extends StatefulWidget {
  const WatchVideoWidget({Key? key}) : super(key: key);
                            ...
                            Row(
                              ...
                              children: [
                                FlutterFlowYoutubePlayer(
                                  url:
                                      'https://www.youtube.com/watch?v=mmYTvZAOj8M',
                                  autoPlay: false,
                                  looping: true,
                                  mute: false,
                                  showControls: true,
